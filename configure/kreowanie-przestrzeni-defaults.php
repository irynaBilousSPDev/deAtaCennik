 ...
 */
function akademiata_kreo_merge_defaults(array $defaults, ?array $acf): array {
    ...
    foreach ($defaults as $key => $default_val) {
        ...
        if (is_array($default_val)) {
            $out[$key] = akademiata_kreo_merge_defaults(
                $default_val,
...
function akademiata_kreowanie_przestrzeni_fields($acf_fields): array {
    ...
    foreach ($defaults as $section_key => $section_defaults) {
        $merged[$section_key] = akademiata_kreo_merge_defaults(
            $section_defaults,

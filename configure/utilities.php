    ...
    if ($strings === null) {
        $strings = array(
            ...
            'offer_toolbar_aria' => array(
                ...
                'uk' => 'Пошук і фільтри пропозицій',
                'ru' => 'Поиск и фильтры предложений',
            ),
            'offer_search_label' => array(
                'pl' => 'Wyszukaj specjalność',
                'en' => 'Search specialization',
                'uk' => 'Шукати спеціалізацію',
                'ru' => 'Искать специализацию',
            ),
            'offer_search_placeholder' => array(
                'pl' => 'Wyszukaj specjalność lub słowo kluczowe…',
                'en' => 'Search specialization or keyword…',
            ...
            'offer_chip_all' => array(
                'pl' => 'Wszystkie',
                'en' => 'All',
                'uk' => 'Усі',
                'ru' => 'Все',
            ),
            'offer_chip_degree' => array(
                'pl' => 'Typ studiów',
                'en' => 'Type of studies',
                'uk' => 'Тип навчання',
                'ru' => 'Тип обучения',
            ),
            'offer_chip_city' => array(
                'pl' => 'Miasto',
                'en' => 'City',
                'uk' => 'Місто',
                'ru' => 'Город',
            ),
            'offer_chip_program' => array(
                'pl' => 'Kierunek studiów',
                'en' => 'Field of study',
                'uk' => 'Напрям навчання',
                'ru' => 'Направление обучения',
            ),
            'offer_chip_language' => array(
                'pl' => 'Język',
                'en' => 'Language',
                'uk' => 'Мова',
                'ru' => 'Язык',
            ),
            'offer_clear_filters' => array(
                'pl' => 'Wyczyść filtry',
                'en' => 'Clear filters',
                'uk' => 'Очистити фільтри',
                'ru' => 'Очистить фильтры',
            ),
            'offer_view_toggle_aria' => array(
                'pl' => 'Widok wyników',
                'en' => 'Results view',
                'uk' => 'Вигляд результатів',
                'ru' => 'Вид результатов',
            ),
            'offer_view_grid_aria' => array(
                'pl' => 'Widok siatki',
                'en' => 'Grid view',
                'uk' => 'Вигляд сітки',
                'ru' => 'Вид сетки',
            ),
            'offer_view_list_aria' => array(
                'pl' => 'Widok listy',
                'en' => 'List view',
                'uk' => 'Вигляд списку',
                'ru' => 'Вид списка',
            ...
            'offer_filter_no_options' => array(
                'pl' => 'Brak opcji filtra.',
                'en' => 'No filter options.',
                'uk' => 'Немає варіантів фільтра.',
                'ru' => 'Нет вариантов фильтра.',
            ),
            'offer_no_results' => array(
                'pl' => 'Nie znaleziono żadnych wyników',
                'en' => 'No results found',
                'uk' => 'Нічого не знайдено',
                'ru' => 'Ничего не найдено',
            ),
            'offer_filter_back' => array(
                'pl' => 'Wróć',
                'en' => 'Back',
                'uk' => 'Назад',
                'ru' => 'Назад',
            ),
            'offer_filter_panel_title' => array(
                'pl' => 'Filtruj ofertę',
                'en' => 'Filter offers',
                'uk' => 'Фільтрувати пропозиції',
                'ru' => 'Фильтровать предложения',
            ),
            'offer_show_results' => array(
                'pl' => 'Pokaż wyniki',
                'en' => 'Show results',
                'uk' => 'Показати результати',
                'ru' => 'Показать результаты',
            ),
            'filter_tags_heading' => array(
                'pl' => 'Filtry:',
                'en' => 'Filters:',
                'uk' => 'Фільтри:',
                'ru' => 'Фильтры:',
            ),
            'offer_filter_degree' => array(
                'pl' => 'Studia',
                'en' => 'Studies',
                'uk' => 'Навчання',
                'ru' => 'Обучение',
            ),
            'offer_filter_language' => array(
                'pl' => 'Język studiów',
                'en' => 'Language of study',
                'uk' => 'Мова навчання',
                'ru' => 'Язык обучения',
            ),
            'offer_filter_duration' => array(
                'pl' => 'Czas trwania',
                'en' => 'Duration',
                'uk' => 'Тривалість',
                'ru' => 'Продолжительность',
            ),
            'offer_filter_obtained_title' => array(
                'pl' => 'Uzyskany tytuł',
                'en' => 'Degree awarded',
                'uk' => 'Отриманий ступінь',
                'ru' => 'Полученная степень',
            ),
            'offer_filter_interests' => array(
                'pl' => 'Zainteresowania',
                'en' => 'Interests',
                'uk' => 'Інтереси',
                'ru' => 'Интересы',
            ),
            'offer_filter_mode' => array(
                'pl' => 'Forma studiów',
                'en' => 'Mode of study',
                'uk' => 'Форма навчання',
                'ru' => 'Форма обучения',
            ...
            'offer_label_coming_soon' => array(
                'pl' => 'wkrótce',
                'en' => 'coming soon',
                'uk' => 'незабаром',
                'ru' => 'скоро',
            ),
            'offer_label_new' => array(
                'pl' => 'nowość',
                'en' => 'new',
                'uk' => 'новинка',
                'ru' => 'новинка',
            ),
            'offer_ranking_icon_alt' => array(
                'pl' => 'Ikona rankingu',
                'en' => 'Ranking icon',
                'uk' => 'Іконка рейтингу',
                'ru' => 'Иконка рейтинга',
            ),
            'offer_location_icon_alt' => array(
                'pl' => 'Ikona lokalizacji',
                'en' => 'Location icon',
                'uk' => 'Іконка локації',
                'ru' => 'Иконка локации',
            ),
            'offer_card_details' => array(
                'pl' => 'SZCZEGÓŁY',
                'en' => 'DETAILS',
                'uk' => 'ДЕТАЛІ',
                'ru' => 'ПОДРОБНЕЕ',
            ),
            'offer_card_register' => array(
                'pl' => 'ZAPISZ SIĘ',
                'en' => 'APPLY',
                'uk' => 'ЗАПИСАТИСЯ',
                'ru' => 'ЗАПИСАТЬСЯ',
            ...
            'offer_start_timer_pair_1_top' => array(
                'pl' => 'start',
                'en' => 'start',
                'uk' => 'старт',
                'ru' => 'старт',
            ...
            'offer_start_timer_pair_2_top' => array(
                'pl' => 'pierwszego',
                'en' => '1st of',
                'uk' => 'першого',
                'ru' => 'первого',
            ),
            'offer_start_timer_pair_2_bottom' => array(
                'pl' => 'października',
                'en' => 'October',
                'uk' => 'жовтня',
                'ru' => 'октября',
            ),
            'offer_start_timer_pair_3_top' => array(
                'pl' => 'zarezerwuj',
                'en' => 'reserve',
                'uk' => 'зарезервуй',
                'ru' => 'забронируй',
            ),
            'offer_start_timer_pair_3_bottom' => array(
                'pl' => 'swoje miejsce',
                'en' => 'your place',
                'uk' => 'своє місце',
                'ru' => 'своё место',
            ...
            'offer_start_timer_pair_4_bottom' => array(
                'pl' => 'ograniczona',
                'en' => 'limited',
                'uk' => 'обмежено',
                'ru' => 'ограничено',
            ),
            'site_daily_visitors_pl_one' => array(
                'pl' => 'Dziś 1 osoba zainteresowała się studiami na ATA',
                'en' => 'Today 1 person showed interest in studies at ATA',
                'uk' => 'Сьогодні 1 особа зацікавилася навчанням в ATA',
                'ru' => 'Сегодня 1 человек проявил интерес к обучению в ATA',
            ),
            'site_daily_visitors_pl_few' => array(
                'pl' => 'Dziś %d osoby zainteresowały się studiami na ATA',
                'en' => 'Today %d people showed interest in studies at ATA',
                'uk' => 'Сьогодні %d особи зацікавилися навчанням в ATA',
                'ru' => 'Сегодня %d человека проявили интерес к обучению в ATA',
            ),
            'site_daily_visitors_pl_many' => array(
                'pl' => 'Dziś %d osób zainteresowało się studiami na ATA',
                'en' => 'Today %d people showed interest in studies at ATA',
                'uk' => 'Сьогодні %d осіб зацікавилися навчанням в ATA',
                'ru' => 'Сегодня %d человек проявили интерес к обучению в ATA',
            ),
            'site_daily_visitors_en_one' => array(
                'pl' => 'Today 1 person showed interest in studies at ATA',
                'en' => 'Today 1 person showed interest in studies at ATA',
                'uk' => 'Today 1 person showed interest in studies at ATA',
                'ru' => 'Today 1 person showed interest in studies at ATA',
            ),
            'site_daily_visitors_en_many' => array(
                'pl' => 'Today %d people showed interest in studies at ATA',
                'en' => 'Today %d people showed interest in studies at ATA',
                'uk' => 'Today %d people showed interest in studies at ATA',
                'ru' => 'Today %d people showed interest in studies at ATA',
            ),
            'decision_today_days' => array(
                'pl' => 'DNI',
                'en' => 'DAYS',
                'uk' => 'ДНІ',
                'ru' => 'ДНИ',
            ),
            'decision_today_eyebrow' => array(
                'pl' => 'DECYZJA NA DZIŚ',
                'en' => 'DECISION TODAY',
                'uk' => 'РІШЕННЯ СЬОГОДНІ',
                'ru' => 'РЕШЕНИЕ СЕГОДНЯ',
            ),
            'decision_today_title' => array(
                'pl' => 'Zacznij studia bez odkładania decyzji',
                'en' => 'Start your studies without putting off the decision',
                'uk' => 'Почніть навчання без відкладання рішення',
            ...
            'decision_today_group_title_before' => array(
                'pl' => 'W Grupie',
                'en' => 'Group',
                'uk' => 'В групі',
                'ru' => 'В группе',
            ),
            'decision_today_group_title_accent' => array(
                'pl' => 'Taniej!',
                'en' => 'Discount!',
                'uk' => 'Дешевше!',
                'ru' => 'Дешевле!',
            ),
            'decision_today_group_title' => array(
                'pl' => 'W Grupie Taniej!',
                'en' => 'Group Discount!',
                'uk' => 'В групі дешевше!',
                'ru' => 'В группе дешевле!',
            ...
            'decision_today_group_valid_until' => array(
                ...
                'en' => 'Valid until 30 Sep 2026',
                'uk' => 'Діє до 30.09.2026',
                'ru' => 'Действует до 30.09.2026',
            ),
            'decision_today_group_discount' => array(
                'pl' => '−200 / −400 zł',
                'en' => '−200 / −400 PLN',
                'uk' => '−200 / −400 zł',
                'ru' => '−200 / −400 zł',
            ),
            'decision_today_cta' => array(
                'pl' => 'Zaproś znajomych',
                'en' => 'Invite friends',
                'uk' => 'Запросити друзів',
                'ru' => 'Пригласить друзей',
            ),
            'decision_today_share_title' => array(
                'pl' => 'Udostępnij ofertę',
                'en' => 'Share the offer',
                'uk' => 'Поділіться пропозицією',
                'ru' => 'Поделиться предложением',
            ),
            'decision_today_share_message' => array(
                'pl' => 'Zapiszmy się razem na studia w ATA! Taniej w grupie — %s',
                'en' => 'Let\'s enroll together at ATA! Group discount — %s',
                'uk' => 'Запишімося разом на навчання в ATA! Дешевше в групі — %s',
                'ru' => 'Запишемся вместе на учебу в ATA! Дешевле в группе — %s',
            ),
            'decision_today_share_copied' => array(
                'pl' => 'Skopiowano — wklej w wiadomości',
                'en' => 'Copied — paste in a message',
                'uk' => 'Скопійовано — вставте в повідомлення',
                'ru' => 'Скопировано — вставьте в сообщение',
            ),
            'decision_today_share_whatsapp' => array(
                'pl' => 'WhatsApp',
                'en' => 'WhatsApp',
                'uk' => 'WhatsApp',
                'ru' => 'WhatsApp',
            ),
            'decision_today_share_messenger' => array(
                'pl' => 'Messenger',
                'en' => 'Messenger',
                'uk' => 'Messenger',
                'ru' => 'Messenger',
            ),
            'decision_today_share_telegram' => array(
                'pl' => 'Telegram',
                'en' => 'Telegram',
                'uk' => 'Telegram',
                'ru' => 'Telegram',
            ),
            'decision_today_share_instagram' => array(
                'pl' => 'Instagram',
                'en' => 'Instagram',
                'uk' => 'Instagram',
                'ru' => 'Instagram',
            ),
            'decision_today_share_tiktok' => array(
                'pl' => 'TikTok',
                'en' => 'TikTok',
                'uk' => 'TikTok',
                'ru' => 'TikTok',
            ),
            'decision_today_share_snapchat' => array(
                'pl' => 'Snapchat',
                'en' => 'Snapchat',
                'uk' => 'Snapchat',
                'ru' => 'Snapchat',
            ),
            'decision_today_share_copy' => array(
                'pl' => 'Kopiuj link',
                'en' => 'Copy link',
                'uk' => 'Копіювати посилання',
                'ru' => 'Копировать ссылку',
            ),
            'decision_today_share_more' => array(
                'pl' => 'Więcej',
                'en' => 'More',
                'uk' => 'Ще',
                'ru' => 'Ещё',
            ),
            'decision_today_urgency' => array(
                'pl' => 'Pospiesz się — liczba miejsc jest ograniczona!',
            ...
            'decision_today_minutes' => array(
                'pl' => 'MINUT',
                'en' => 'MINUTES',
                'uk' => 'ХВИЛИН',
                'ru' => 'МИНУТ',
            ),
            'decision_today_seconds' => array(
                'pl' => 'SEKUND',
                'en' => 'SECONDS',
                'uk' => 'СЕКУНД',
                'ru' => 'СЕКУНД',

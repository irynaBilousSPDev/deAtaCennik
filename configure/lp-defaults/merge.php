...
function akademiata_lp_merge_defaults(array $defaults, ?array $acf): array {
    ...
    foreach ($defaults as $key => $default_val) {
        ...
        if (is_array($acf_val) && in_array($key, ['city_window_image', 'panel_image', 'hero_photo', 'image', 'badge_image', 'logo', 'logo_image', 'logo_image_old', 'logo_image_new', 'bg_image', 'poster'], true)) {

 ...
 */
function akademiata_katalog_kierunkow_defaults(): array {
 ...
 * @return array<string, array<string, mixed>>
 */
function akademiata_katalog_kierunkow_fields($acf_fields): array {
    $defaults = akademiata_katalog_kierunkow_defaults();

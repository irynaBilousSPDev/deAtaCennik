 ...
 */
function akademiata_portfolio_sprawdzian_defaults(): array {
 ...
 * @return array<string, array<string, mixed>>
 */
function akademiata_portfolio_sprawdzian_fields($acf_fields): array {
    $defaults = akademiata_portfolio_sprawdzian_defaults();

 ...
 */
function akademiata_porownanie_kierunkow_defaults(): array {
 ...
 * @return array<string, array<string, mixed>>
 */
function akademiata_porownanie_kierunkow_fields($acf_fields): array {
    $defaults = akademiata_porownanie_kierunkow_defaults();

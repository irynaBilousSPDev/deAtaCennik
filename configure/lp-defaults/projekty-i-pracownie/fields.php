 ...
 */
function akademiata_projekty_i_pracownie_defaults(): array {
 ...
 * @return array<string, array<string, mixed>>
 */
function akademiata_projekty_i_pracownie_fields($acf_fields): array {
    $defaults = akademiata_projekty_i_pracownie_defaults();

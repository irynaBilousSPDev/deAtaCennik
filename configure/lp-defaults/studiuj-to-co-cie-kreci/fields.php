 ...
 */
function akademiata_studiuj_to_co_cie_kreci_defaults(): array {
 ...
 * @return array<string, array<string, mixed>>
 */
function akademiata_studiuj_to_co_cie_kreci_fields($acf_fields): array {
    $defaults = akademiata_studiuj_to_co_cie_kreci_defaults();

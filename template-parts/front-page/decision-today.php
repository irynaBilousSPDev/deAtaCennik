...
$layouts = is_array($config['layouts'] ?? null) ? $config['layouts'] : array('cards');
?>
<div class="home-decision-wrap">
    <div class="home-decision__intro container">
        <?php if ($eyebrow !== '') : ?>
    ...
    <?php foreach ($layouts as $layout_index => $layout) :
        ...
        $variant_id = 'home-decision-variant-' . ($layout_index + 1);
        ?>
        <section
            class="home-decision home-decision--layout-<?php echo esc_attr($layout); ?>"
            aria-labelledby="<?php echo esc_attr($variant_id); ?>"
            data-countdown-target="<?php echo esc_attr($iso_target); ?>"
        >
            <div class="home-decision__inner container">
                <p id="<?php echo esc_attr($variant_id); ?>" class="home-decision__variant-label">
                    <?php echo esc_html(akademiata_decision_today_variant_label($layout)); ?>
                </p>
                ...
                <div class="home-decision__cards">
                    ...
                    <?php if ($layout === 'compact') : ?>
                        <article class="home-decision__group-strip">
                            ...
                            <?php if ($cta_text !== '' && $cta_url !== '') : ?>
                                <a class="home-decision__cta home-decision__cta--compact" href="<?php echo esc_url($cta_url); ?>">
                                    <span><?php echo esc_html($cta_text); ?></span>
                                    <span class="home-decision__cta-icon" aria-hidden="true">→</span>
                                </a>
                            <?php endif; ?>
                ...
                <?php if ($layout_index === count($layouts) - 1 && (!empty($visitor_payload['show']) || $urgency_text !== '')) : ?>

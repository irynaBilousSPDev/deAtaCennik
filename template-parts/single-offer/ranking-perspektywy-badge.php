...
<span class="ranking-badge-tooltip ranking-badge-tooltip--<?php echo esc_attr($context); ?>"
    ...
    <?php if ($image_url) : ?>
        <img src="<?php echo esc_url($image_url); ?>"
             alt="<?php echo esc_attr(akademiata_get_theme_lang_string('offer_ranking_perspektywy_alt')); ?>"
    ...
    <?php else : ?>
        <span class="ranking-badge-tooltip__fallback">
            ...
            <span><?php echo esc_html(akademiata_get_theme_lang_string('offer_ranking_perspektywy_subline')); ?></span>
        </span>
    <?php endif; ?>
